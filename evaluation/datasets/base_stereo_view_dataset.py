...
class BaseStereoViewDataset (EasyDataset):
    ...
    def _crop_resize_if_necessary(self, image, intrinsics, resolution, rng=None, info=None):
        ...
        image, intrinsics = crop_image(image, intrinsics, crop_bbox)
        ...
        image, intrinsics = rescale_image(image, intrinsics, target_resolution)
        ...
        image, intrinsics2 = crop_image(image, intrinsics, crop_bbox)
